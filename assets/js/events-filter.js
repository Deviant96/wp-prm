document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateEventList(data) {
        ...
        data.items.forEach(event => {
            ...
            html += `
                <div class="flex flex-col sm:flex-row bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden" data-id="${id}">
                    ...
                    <div class="p-4 flex flex-col justify-between flex-grow">
                        <div>
                            <div class="text-sm text-gray-500 dark:text-gray-400 mb-1">${formatDate(date)} – ${eventType}</div>
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            <a href="${link}" class="text-blue-600 dark:text-blue-400 hover:underline text-sm">View Details</a>
