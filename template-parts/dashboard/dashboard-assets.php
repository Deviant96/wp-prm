...
<div class="space-y-4" id="assets-page" data-layout="<?php echo esc_attr($layout); ?>">
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
        <input type="text"
            ...
            class="w-full sm:w-64 px-3 py-2 rounded border dark:bg-gray-800 dark:border-gray-700"
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function createSkeletonCard() {
            ...
            card.className = "asset-card bg-white dark:bg-gray-800 rounded shadow p-4 relative animate-pulse";
            card.innerHTML = `
                <div class="h-5 bg-gray-300 dark:bg-gray-700 rounded w-2/3 mb-2"></div>
                <div class="h-4 bg-gray-200 dark:bg-gray-600 rounded w-1/3 mb-4"></div>
